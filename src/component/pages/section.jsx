        ...
        <><main>
            <div className="main">
                ...
                <div className="content">
                    ...
                    <p className='main-p '> To The (Site Name)</p>

                    <ul className="main-links">
                        <li> <Link className="main-link" to='/'>Book A Ride</Link></li>
                        <li> <Link className="main-link" to='/'>Become A Driver </Link></li>
                    </ul>
                </div>
                ...
                <div className="body">
                    <div className="container">
                        ...
                        <div className="">
                            <h1 className='container-text'>Ride With The Most Comfortable,<br />Affordable, Experience <br />And Fast Drivers </h1>
                        </div>
                    </div>
                </div>
                ...
                <div className="hero">
                    <div className="banner-hero">
                        <div className="banner-text">
                            ...
                            <p className='banner-p '>Set your own schedule, be your own boss.</p>
                        </div>
                        <div className="driver-btn">
                            <Link className="banner-link" to='/'>Sign Up To Become A Driver </Link>
                        </div>
                    </div>
                ...
                <section className="svg-all">
                    <div className="svg-container">
                        ...
                        <div className="first-svg">
                            ...
                            <p className='svg-p '>We aim to offer the most affordable <br /> ride prices in every city.<br /> See for yourself!...</p>
                        </div>

                        <div className="first-svg">
                            <img className='svg' src={phone} alt="phone" />
                            <h3 className='svg-h'>Easy To Use</h3>
                            <p className='svg-p '>Get too your destination as quick and as fast as possible.</p>
                        </div>
                ...
                <section className="pick-ride">
                    <div className="pick-container">
                        ...
                        <div className="pick">
                            ...
                            <p className='pick-p '>Pick your destination, book a ride, <br /> meet your driver and enjoy the ride!......
                ...
                <section className="win">
                    <div className="win-container">
                        ...
                        <p className='win-p '>Refer a friend to win free rides,  concert tickets   and so much more on Us.</p>
